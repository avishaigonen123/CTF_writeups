...
Welcome to the OverTheWire Wargames writeups hub. Choose a wargame below to view detailed solutions.
...
<div class="wargame-container">
  ...
  {% for folder in site.pages %}
    {% if folder.path contains 'overthewire/' and folder.path != 'overthewire/index.md' %}
      {% assign path_parts = folder.path | split: '/' %}
      {% assign folder_name = path_parts[1] %}
      {% unless seen contains folder_name %}
        {% capture folder_path %}overthewire/{{ folder_name }}{% endcapture %}
