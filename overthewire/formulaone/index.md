...
<style>
  ...
  .formulaone-sidebar ul {
    list-style: none;
    padding-left: 0;
    font-size: 1rem;
    margin: 0;
  }
  .formulaone-sidebar li {
    margin-bottom: 0.5rem;
  }
  .formulaone-sidebar a {
    display: block;
    padding: 6px 12px;
    border-radius: 6px;
  ...
  .formulaone-sidebar::-webkit-scrollbar {
    width: 8px;
  }
  .formulaone-sidebar::-webkit-scrollbar-thumb {
    background-color: #16a085;
    border-radius: 4px;
  }
  .formulaone-sidebar::-webkit-scrollbar-track {
...
<div class="formulaone-container">

  <!-- Sidebar -->
  <div class="formulaone-sidebar">
    <h00>Levels</h00>
    <ul>
