...
Welcome to the **Manpage** wargame writeups! Click a level below to view the detailed solution.
...
<div class="level-grid">
  ...
  %}
  {% assign sorted_levels = manpage_pages | sort_natural: "path" %}
  {% for page in sorted_levels %}
    {% assign name = page.path | split: '/' | last | split: '.' | first %}
    {% if name != "index" %}
    <a class="level-card" href="{{ site.baseurl }}/overthewire/manpage/{{ name }}.html">
