...
<style>
  ...
  .krypton-sidebar::-webkit-scrollbar {
    width: 8px;
  }
  .krypton-sidebar::-webkit-scrollbar-thumb {
    background-color: #16a085;
    border-radius: 4px;
  }
  .krypton-sidebar::-webkit-scrollbar-track {
...
<div class="krypton-container">

  <!-- Sidebar -->
  <div class="krypton-sidebar">
    <h00>Levels</h00>
    <ul>
