---
layout: default
title: WebSec.il Writeups
---

Welcome to the WebSec.il Wargames writeups hub. Choose a wargame below to view detailed solutions.
...
<div class="wargame-container">
  ...
  {% for folder in site.pages %}
    {% if folder.path contains 'websec.il/' and folder.path != 'websec.il/index.md' %}
      {% assign path_parts = folder.path | split: '/' %}
      {% assign folder_name = path_parts[1] %}
      {% unless seen contains folder_name %}
        {% capture folder_path %}websec.il/{{ folder_name }}{% endcapture %}
