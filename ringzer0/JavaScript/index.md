...
This folder contains solutions for the [Javascript](http://overthewire.org/wargames/JavaScript/) wargame from OverTheWire.
  ...
  <div class="behemoth-sidebar">
    ...
    <ul>
      {% assign JavaScript_pages = site.pages 
        | where_exp: "p", "p.path contains 'overthewire/JavaScript'" 
        | reject: "path", "overthewire/JavaScript/index.md" 
        | reject: "path", "overthewire/JavaScript/index.html" 
      %}
