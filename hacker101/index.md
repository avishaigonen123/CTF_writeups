...
Welcome to the Hacker101 Ctf's hub. Choose ctf below to view detailed solutions.
...
<div class="wargame-container">
  ...
  {% for folder in site.pages %}
    {% if folder.path contains 'hacker101/' and folder.path != 'hacker101/index.md' %}
      {% assign path_parts = folder.path | split: '/' %}
      {% assign folder_name = path_parts[1] %}
      {% unless seen contains folder_name %}
        {% capture folder_path %}hacker101/{{ folder_name }}{% endcapture %}
