---
layout: default
title: android_hacking
---

Welcome to the Android_Hacking Ctf's hub. Choose ctf below to view detailed solutions.
...
<div class="wargame-container">
  ...
  {% for folder in site.pages %}
    {% if folder.path contains 'android_hacking/' and folder.path != 'android_hacking/index.md' %}
      {% assign path_parts = folder.path | split: '/' %}
      {% assign folder_name = path_parts[1] %}
      {% unless seen contains folder_name %}
        {% capture folder_path %}android_hacking/{{ folder_name }}{% endcapture %}
