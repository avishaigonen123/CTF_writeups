...
Welcome to the Android Ctf's hub. Choose ctf below to view detailed solutions.
...
<div class="wargame-container">
  ...
  {% for folder in site.pages %}
    {% if folder.path contains 'android_ctfs/' and folder.path != 'android_ctfs/index.md' %}
